...
struct Builder {
  ...
  bool StartEdge(Edge* edge, std::string* err, bool remote);

  /// Update status ninja logs following a command termination.
  /// @return false if the build can not proceed further due to a fatal error.
  bool FinishCommand(CommandRunner::Result* result, std::string* err, bool remote, bool silentOnSuccess);
...
struct BuildStatus {
  ...
  void BuildEdgeStarted(const Edge* edge, const std::string& prefix = "");
  void BuildEdgeFinished(Edge* edge, bool success, bool silent, const std::string& output,
 ...
 private:
  void PrintStatus(const Edge* edge, EdgeStatus status, const std::string& prefix = "");
